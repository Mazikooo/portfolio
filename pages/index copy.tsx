      ...
      <main className={styles.main}>
        ...
        >
          ...
          <p className={styles.sectionContent}>
            Hello! I&apos;m Muhammad Azis Sujatmiko, an Information Systems
            student at Amikom University with a focus on web and software
            development. I possess technical skills in programming and actively
            develop my abilities through projects and coursework. I have
            experience in building and managing websites using various
            technologies and frameworks. My strong soft skills include
          ...
          <p className={styles.sectionContent}>
            ...
            projects. I thrive in fast-paced environments and am constantly
            seeking new challenges to improve my skills and contribute to
            innovative solutions. My expertise lies in full-stack development,
            with a particular focus on creating user-friendly interfaces and
            optimizing backend performance.
          </p>
          <p className={styles.sectionContent}>
            In addition to my technical skills, I am a strong advocate for
            continuous learning and professional growth. I regularly attend
            industry conferences and participate in online courses to stay
            ...
            technologies, writing technical blogs, or contributing to
            ...
            <div className={styles.projectRow}>
              ...
              >
                ...
                <p className={styles.projectDescription}>
                  KEKOST is a kost room rental platform that makes it easy for
                  kost seekers to find and book rooms online. We offer a wide
                  selection of boarding houses with the best facilities.
                </p>
              ...
              >
                ...
                <p className={styles.projectDescription}>
                  Sayurin is a web-based platform that allows farmers and
                  traders to interact directly. The platform allows farmers to
                  list their products and merchants can easily search for the
                  products they need and make purchases online.
                </p>
                <div className={styles.technologyStack}>
                  <Image
                    src="/images/php-logo.png"
              ...
              >
                ...
                <p className={styles.projectDescription}>
                  ...
                  developers, designers, and website owners speed up their
          ...
          <div className={styles.contactContent}>
            <div className={styles.textContent}>
              <p className={styles.sectionContent}>
                ...
                collaborations. Feel free to reach out to me through the contact
                details below or connect with me on LinkedIn. I look forward to
                hearing from you!
              </p>
              <p className={styles.sectionContent}>
